...
### 💞 我们的片单 `OurFilmsBoard`（电影院内新标签）
- 电影院顶部两个标签：「🎬 Nana 影库」（原豆瓣清单）｜「💞 我们的片单」（Supabase 共享表 `shared_films`）
...
- **⬇️ 影库导入**：底部按钮可把 Nana 影库一键导入（只导想看 / 导全部），按片名去重，影库状态与星星记到 Nana 名下（在 Nana 手机上导才带得上她的星星）
