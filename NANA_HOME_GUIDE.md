...
- 🕹️ 地下室 `BasementScene`（底部导航第 4 格，替换了盥洗室；盥洗室移入更多抽屉）：旅行青蛙画风秘密基地。可点：街机/飞镖/桌游堆/椅子/小沙发/墙上捆捆带（随机趣味台词）、🧃 苹果汁 + 🥕 胡萝卜汁（倒进杯子、计干杯数）、纸箱里的好好（她不睡正经窝只睡纸箱）；开关：💡 灯泡、🪩 迪斯科球（彩虹转灯蹦迪模式）；楼梯点击=回家
